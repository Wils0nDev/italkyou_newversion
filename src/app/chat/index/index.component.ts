...
import { Chatlist } from '../../core/models/chat.models';
...
export class IndexComponent implements OnInit {
  ...
  chatListAll() {
    ...
    const request = {
      ...
      "session_key": "g8Uf6VhPbbTqAcSNjZogmlx",
      "data": {
          "user_id": "61897d3d0fef2941b8060fec"
      }
    }

    this.chatService.ChatListAll(request).subscribe({
      next: (data) =>{
        this.chatList = data
      }
    })
  ...
  onChatInfoClicked() {
    (
      document.querySelector('.user-profile-sidebar') as HTMLElement
    ).style.display = 'block';
  }
